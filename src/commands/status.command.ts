...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Floo status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("floo security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("floo security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.floo.africa/faq");
  runtime.log("Troubleshooting: https://docs.floo.africa/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("floo status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("floo logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("floo status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("floo gateway probe")}`);
  }
}
